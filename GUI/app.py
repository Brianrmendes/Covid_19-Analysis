...
def main():
    ...
    if choice == "Public Health":
        ...
        temp = pd.read_excel("E:/Python_projects/Mini-Project/Main-Project/Files/Temp.xlsx", sheet_name='Sheet1')
        ...
        def first_plot():
            ...
            df = pd.read_csv('E:/Python_projects/Mini-Project/Main-Project/Files/NIFTY50_all.csv')
            df["Date"] = pd.to_datetime(df["Date"])
            df = df.set_index("Date")
